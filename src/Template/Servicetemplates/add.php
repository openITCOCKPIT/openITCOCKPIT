...
<ol class="breadcrumb page-breadcrumb">
    ...
    <li class="breadcrumb-item">
        <a ui-sref="ServicetemplatesIndex">
            <i class="fa-solid fa-pen-to-square"></i> <?php echo __('Service templates'); ?>
        </a>
    </li>
    <li class="breadcrumb-item">
                                    ...
                                    <label class="control-label">
                                        <?php if ($this->Acl->hasPermission('edit', 'timeperiods')): ?>
                                            <a ui-sref="TimeperiodsEdit({id:post.Servicetemplate.check_period_id})"
                                               ng-if="post.Servicetemplate.check_period_id > 0">
                                                <?= __('Check period'); ?>
                                            </a>
                                            <span
                                                ng-if="post.Servicetemplate.check_period_id == 0"><?php echo __('Check period'); ?></span>
                                        <?php else: ?>
                                            <?= __('Check period'); ?>
                                        <?php endif; ?>
                                    </label>
                                    ...
                                    <label class="control-label">
                                        <?php if ($this->Acl->hasPermission('edit', 'commands')): ?>
                                            <a ui-sref="CommandsEdit({id:post.Servicetemplate.command_id})"
                                               ng-if="post.Servicetemplate.command_id > 0">
                                                <?= __('Check command'); ?>
                                            </a>
                                            <span
                                                ng-if="post.Servicetemplate.command_id == 0"><?php echo __('Check command'); ?></span>
                                        <?php else: ?>
                                            <?= __('Check command'); ?>
                                        <?php endif; ?>
                                    </label>
                            ...
                            <div class="card-body">
                                <div class="custom-control custom-checkbox"
                                    ...
                                    <input type="checkbox"
                                           ...
                                           ng-true-value="1"
                                           ng-false-value="0"
                                           ng-model="post.Servicetemplate.notifications_enabled">
                                    ...
                                    <label class="control-label" for="NotificationPeriod">
                                        <?php if ($this->Acl->hasPermission('edit', 'timeperiods')): ?>
                                            <a ui-sref="TimeperiodsEdit({id:post.Servicetemplate.notify_period_id})"
                                               ng-if="post.Servicetemplate.notify_period_id > 0">
                                                <?php echo __('Notification period'); ?>
                                            </a>
                                            <span
                                                ng-if="post.Servicetemplate.notify_period_id == 0"><?php echo __('Notification period'); ?></span>
                                        <?php else: ?>
                                            <?php echo __('Notification period'); ?>
                                        <?php endif; ?>
                                    </label>
                                ...
                                <div class="form-group required"
                                    ...
                                    <label class="control-label" for="ServiceEventHandlerSelect">
                                        <?php if ($this->Acl->hasPermission('edit', 'commands')): ?>
                                            ...
                                            <span
                                                ng-if="post.Servicetemplate.eventhandler_command_id == 0"><?php echo __('Event Handler'); ?></span>
                                        <?php else: ?>
                                            <?php echo __('Event Handler'); ?>
                                        <?php endif; ?>
                                    </label>
                            ...
                            <div class="card-body">
                                <div class="float-right">
                                    ...
                                    <button class="btn btn-primary" type="submit">
                                        <?php echo __('Create service template'); ?>
                                    </button>
                                    <a back-button href="javascript:void(0);" fallback-state='ServicetemplatesIndex'
                                       class="btn btn-default">
                                        <?php echo __('Cancel'); ?>
