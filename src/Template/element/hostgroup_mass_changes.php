...
<div class="row">
    ...
    <div class="col-xs-12 col-md-2"><a
                href="<?php echo Router::url(array_merge(['controller' => 'hostgroups', 'action' => 'listToPdf'], $this->params['named'])); ?>/.pdf"
    ...
    <input type="hidden" id="delete_message_h2"
           value="<?php echo __('Do you really want delete the selected hostgroups?'); ?>"/>
