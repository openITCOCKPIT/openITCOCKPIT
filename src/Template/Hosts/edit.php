        ...
        <div id="panel-1" class="panel">
            <div class="panel-hdr">
                <h2>
                    ...
                    <span class="fw-300"><i>{{post.Host.name}}</i></span>
                </h2>
                        ...
                        <div class="card margin-bottom-10">
                            ...
                            <div class="card-body">
                                ...
                                <div class="form-group" ng-class="{'has-error': errors.hosts_to_containers_sharing}">
                                    ...
                                    <div
                                        ng-if="post.Host.host_type === <?= EVK_HOST; ?>">
                                        <!-- EVC hosts can't be shared accress containers -->
                                        ...
                                        <div class="chosen-container chosen-container-single chosen-disabled"
                                            ...
                                            <a class="chosen-single fake-chosen-select">
                                                <span>
                                                    <?= __('Not available for EVC hosts.'); ?>
                                                </span>
                                                <div><b></b></div>
                                            </a>
                                        </div>
                                ...
                                <div class="form-group required" ng-class="{'has-error': errors.name}">
                                    <label class="control-label">
                                        ...
                                        <span
                                            ng-if="post.Host.host_type === <?= EVK_HOST; ?>"><?= __('/ Name of correlation') ?></span>
                                    </label>
                                    <input
                                        id="HostName"
                                        class="form-control"
                        ...
                        <div class="card margin-top-10">
                            <div class="card-body">
                                <div class="float-right">
                                    <button type="submit" ng-if="post.Host.host_type === <?= EVK_HOST; ?>"
                                            class="btn btn-primary waves-effect waves-themed">
                                        <?php echo __('Update host'); ?>
                                    </button>
                                    <div class="btn-group" ng-if="post.Host.host_type !== <?= EVK_HOST; ?>">
