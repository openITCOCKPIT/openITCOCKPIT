...
<ol class="breadcrumb page-breadcrumb">
    ...
    <li class="breadcrumb-item">
        <a ui-sref="LocationsIndex">
            <i class="fa fa-location-arrow"></i> <?php echo __('Locations'); ?>
        </a>
    </li>
    <li class="breadcrumb-item">
            ...
            <div class="panel-hdr">
                ...
                <div class="panel-toolbar">
                    ...
                    <?php if ($this->Acl->hasPermission('add', 'locations')): ?>
                        <button class="btn btn-xs btn-success mr-1 shadow-0" ui-sref="LocationsAdd">
                                    ...
                                    <div class="btn-group btn-group-xs" role="group">
                                        ...
                                        <div class="dropdown-menu dropdown-menu-right">
                                            ...
                                            <?php if ($this->Acl->hasPermission('index', 'changelogs')): ?>
                                                <a ui-sref="ChangelogsEntity({objectTypeId: 'location', objectId: location.Location.id})"
                                                   class="dropdown-item">
                                            ...
                                            <?php if ($this->Acl->hasPermission('delete', 'locations')): ?>
                                                <div class="dropdown-divider" ng-if="location.Location.allowEdit"></div>
