...
use itnovum\openITCOCKPIT\Core\Permissions\ContainersPermissions;

class MapContainersPermissions extends ContainersPermissions {
    ...
    public function areContainersChangeable() {
        ...
        foreach ($this->containerIds as $containerId) {
            //Has the user write permissions to all containers of the map?
