...
<div class="row">
    <div class="col-xl-12">
        <div id="panel-1" class="panel">
            <div class="panel-hdr">
                <h2>
                    <?php echo __('Create new contact'); ?>
                </h2>
                        ...
                        <div class="form-group" ng-class="{'has-error': errors.user_id}">
                            <label class="control-label">
                                <?php if ($this->Acl->hasPermission('edit', 'users')): ?>
                                    ...
                                    <span ng-if="post.Contact.user_id == 0"><?php echo __('User'); ?></span>
                                <?php else: ?>
                                    <?php echo __('User'); ?>
                                <?php endif; ?>
                            </label>
                                        ...
                                        <div class="form-group required"
                                            ...
                                            <label class="control-label">
                                                <?php if ($this->Acl->hasPermission('edit', 'timeperiods')): ?>
                                                    ...
                                                    <span ng-if="post.Contact.host_timeperiod_id == 0"><?php echo __('Host time period'); ?></span>
                                                <?php else: ?>
                                                    <?php echo __('Host time period'); ?>
                                                <?php endif; ?>
                                            </label>
                                            ...
                                            <?php foreach ($hostOptions as $hostOption): ?>
                                                <div class="custom-control custom-checkbox margin-bottom-10"
                                                    ...
                                                    <label class="custom-control-label"
                                                        ...
                                                        <span class="badge badge-<?php echo $hostOption['class']; ?> notify-label"><?php echo $hostOption['text']; ?></span>
                                        ...
                                        <div class="form-group required"
                                            ...
                                            <label class="control-label">
                                                <?php if ($this->Acl->hasPermission('edit', 'timeperiods')): ?>
                                                    ...
                                                    <span ng-if="post.Contact.service_timeperiod_id == 0"><?php echo __('Service time period'); ?></span>
                                                <?php else: ?>
                                                    <?php echo __('Service time period'); ?>
                                                <?php endif; ?>
                                            </label>
                                            ...
                                            <?php foreach ($serviceOptions as $serviceOption): ?>
                                                <div class="custom-control custom-checkbox margin-bottom-10"
                                                    ...
                                                    <label class="custom-control-label"
                                                        ...
                                                        <span class="badge badge-<?php echo $serviceOption['class']; ?> notify-label"><?php echo $serviceOption['text']; ?></span>
