                            ...
                            <div class="form-group required" ng-class="{'has-error': errors.services}">
                                ...
                                <div class="input-group">
                                    ...
                                    <select
                                        ...
                                        ng-options="service.key as (service.value.disabled == 0)?service.value.servicename:service.value.servicename+'🔌' group by service.value._matchingData.Hosts.name disable when service.value.disabled for service in services"
                            ...
                            <div class="form-group form-group arrowd-vertical-on-right"
                                ...
                                <div class="input-group">
                                    ...
                                    <select
                                        ...
                                        ng-options="service.key as (service.value.disabled == 0)?service.value.servicename:service.value.servicename+'🔌' group by service.value._matchingData.Hosts.name disable when service.value.disabled for service in services_excluded"
                            ...
                            <div class="card-body">
                                <div class="float-right">
                                    <button class="btn btn-primary"
                                            type="submit"
                                            ng-click="submit()"><?php echo __('Update service escalation'); ?></button>
                                    <a back-button href="javascript:void(0);" fallback-state='ServiceescalationsIndex'
