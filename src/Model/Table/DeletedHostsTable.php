 ...
 * DeletedHosts Model
 *
 * @method \App\Model\Entity\DeletedHost get(mixed $primaryKey, array|string $finder = 'all', \Psr\SimpleCache\CacheInterface|string|null $cache = null, \Closure|string|null $cacheKey = null, mixed ...$args)
 ...
 * @method \App\Model\Entity\DeletedHost findOrCreate($search, ?callable $callback = null, array $options = [])
 *
